                ...
                <div class="inner">
                    <div class="box1 alt vcarBaner">
                        <div class="inner linkAriane">
                            ...
                            <span>></span>
                            <a href="" class="currentLink">Mise à joour</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div>
    <form action="{{ route('car.edit') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="gLineField m1-2 R-login">
            ...
            <input type="hidden" name="id" value="{{ $toUpadate['id']  }}">
            @if($errors->has('image'))
        ...
        <div class="gLineField m1-2 R-login">
            ...
            <input value="{{ $toUpadate['name'] }}" type="text" name="name" placeholder="nom de votre vehicule" value="">
            @if($errors->has('name'))
        ...
        <div class="gLineField m1-2 R-login">
            ...
            <input value="{{ $toUpadate['price'] }}" class="" type="text" name="price" placeholder="prix" value="">
            @if($errors->has('price'))
